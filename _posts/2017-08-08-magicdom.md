...
{{< figure src="/img/magicdom/reflector.png" title="DOM Object and Reflector" >}}
...
{{< figure src="assets/img/magicdom/transform.png" title="MagicDOM" >}}
...
{{< figure src="assets/img/magicdom/getid.png" title="GetId" >}}
...
~~~
{{< figure src="assets/img/magicdom/setid.png" title="SetId" >}}
...
This method is tested by calling 102400 times in a loop and measure the total
time.
{{< figure src="assets/img/magicdom/getattributes.png" title="GetAttributes" >}}
...
{{< figure src="assets/img/magicdom/setattributes.png" title="SetAttributes" >}}
...
{{< figure src="assets/img/magicdom/appendchild.png" title="AppendChilds" >}}
